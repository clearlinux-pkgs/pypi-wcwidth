...
Source0  : https://files.pythonhosted.org/packages/a6/ad/428bc4ff924e66365c96994873e09a17bb5e8a1228be6e8d185bc2a11de9/wcwidth-0.2.9.tar.gz
...
%prep
%setup -q -n wcwidth-0.2.9
cd %{_builddir}/wcwidth-0.2.9
pushd ..
cp -a wcwidth-0.2.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698767340
